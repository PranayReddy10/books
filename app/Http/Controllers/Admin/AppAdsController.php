...
class AppAdsController extends MainAdminController
{
    ...
    {     
         ...
         // exit; 
          ...
          {
            $page_title='Unity Ads';

            return view('admin.pages.ad.unity',compact('page_title','post_info','ads_info'));
          }
    ...
    public function admob(Request $request)
    {
        $data =  \Request::except(array('_token')) ;
          ...
          $rewarded_on_off= isset($inputs['rewarded_on_off'])?$inputs['rewarded_on_off']:"0";
          $rewarded_id= isset($inputs['rewarded_id'])?$inputs['rewarded_id']:'';
          

          $ads_info=json_encode(['publisher_id' => $publisher_id,'banner_on_off' => $banner_on_off,'banner_id' => $banner_id,'interstitial_on_off' => $interstitial_on_off,'interstitial_id' => $interstitial_id,'interstitial_clicks' => $interstitial_clicks,'native_on_off' => $native_on_off,'native_id' => $native_id,'native_position' => $native_position,'rewarded_on_off' => $rewarded_on_off,'rewarded_id' => $rewarded_id]);  
    ...
    public function unity(Request $request)
    {
        $data =  \Request::except(array('_token')) ;
        ...
        $inputs = $request->all();
          ...
          $rewarded_on_off= isset($inputs['rewarded_on_off'])?$inputs['rewarded_on_off']:"0";
          $rewarded_id= isset($inputs['rewarded_id'])?$inputs['rewarded_id']:'';
          $ads_info=json_encode(['publisher_id' => $publisher_id,'banner_on_off' => $banner_on_off,'banner_id' => $banner_id,'interstitial_on_off' => $interstitial_on_off,'interstitial_id' => $interstitial_id,'interstitial_clicks' => $interstitial_clicks,'rewarded_on_off' => $rewarded_on_off,'rewarded_id' => $rewarded_id]);
