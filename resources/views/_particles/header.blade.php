              ...
              <div class="main-nav leftnav">
                ...
                <div id="menu" class="collapse header-menu">
                  <ul class="nav vfx-item-nav">
                    ...
                    <li><a href="{{ URL::to('sports') }}" title="{{trans('words.sports_text')}}">{{trans('words.sports_text')}}</a> <span class="arrow"></span>
                    ...
                    <li><a href="{{ URL::to('livetv') }}" title="{{trans('words.live_tv')}}">{{trans('words.live_tv')}}</a> <span class="arrow"></span>
                      <ul class="dm-align-2 mega-list">
