            ...
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <div class="row">
                 ...
                 {!! Form::open(array('url' => array('admin/ad_list/unity'),'class'=>'form-horizontal','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Rewarded ON/OFF</label>
                    <div class="col-sm-8">
                      <input type="checkbox" name="rewarded_on_off" value="1" data-plugin="switchery" data-color="#28a745" data-size="small" @if(isset($ads_info->rewarded_on_off) && $ads_info->rewarded_on_off==1) {{ 'checked' }} @endif />
                    </div>
                  </div>

                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Rewarded Ad ID</label>
                    <div class="col-sm-8">
                      <input type="text" name="rewarded_id" value="{{ isset($ads_info->rewarded_id) ? stripslashes($ads_info->rewarded_id) : null }}" class="form-control">
                    </div>
                  </div>
